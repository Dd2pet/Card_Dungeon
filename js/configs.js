...
// ── GATHERING RARITY CONFIG ──────────────────────────────────────
const GatheringRarityConfig = Object.freeze({
  common:    { label: 'Обычный',     color: '#9ca3af', priceMult: 1.0,  glowColor: 'rgba(156,163,175,0.3)' },
  uncommon:  { label: 'Необычный',   color: '#4ade80', priceMult: 2.0,  glowColor: 'rgba(74,222,128,0.3)'  },
  rare:      { label: 'Редкий',      color: '#60a5fa', priceMult: 4.0,  glowColor: 'rgba(96,165,250,0.3)'  },
  epic:      { label: 'Эпический',   color: '#c084fc', priceMult: 8.0,  glowColor: 'rgba(192,132,252,0.3)' },
  legendary: { label: 'Легендарный', color: '#fbbf24', priceMult: 16.0, glowColor: 'rgba(251,191,36,0.3)'  },
  mythic:    { label: 'Мифический',  color: '#f87171', priceMult: 32.0, glowColor: 'rgba(248,113,113,0.3)' },
});
  ...
  npcs: [
    {
      id: 'healer',
      av: '💚',
      name: 'Целительница Ирис',
      title: 'Лекарь гильдии',
      unlockLv: 1,
      greetings: {
        newbie: ['Добро пожаловать, новичок! Чем могу помочь?', 'Выглядишь неплохо для начинающего!'],
        weak:   ['Ты растёшь, герой. Береги себя.', 'Раны заживают быстрее с моей помощью.'],
        mid:    ['Серьёзный воин. Что тебя беспокоит?', 'Мои зелья к твоим услугам.'],
        strong: ['Великий герой! Честь лечить тебя.', 'Даже легендарные воины нуждаются в отдыхе.'],
      },
      services: [
        { id: 'heal_full', label: '❤️ Полное исцеление',      cost: 50  },
        { id: 'heal_mp',   label: '💙 Восстановить ману',     cost: 30  },
        { id: 'cure_all',  label: '✨ Снять все статусы',     cost: 80  },
        { id: 'resurrect', label: '🌟 Усилить HP (+20 maxHP)', cost: 200 },
      ],
    },
    {
      id: 'trainer',
      ...
      unlockLv: 3,
      greetings: {
        newbie: ['Слабак! Но я сделаю из тебя воина.', 'Тренируйся или умри — вот мой девиз.'],
        weak:   ['Прогресс есть. Но нужно больше!', 'Сила — это привычка. Тренируйся каждый день.'],
        mid:    ['Неплохо! Ты становишься достойным бойцом.', 'Ещё немного — и ты будешь непобедим.'],
        strong: ['Ты превзошёл многих моих учеников!', 'Честь тренировать такого воина.'],
      },
      services: [
        { id: 'train_atk',  label: '⚔️ Тренировка ATK (+2)',   cost: 100 },
        { id: 'train_def',  label: '🛡️ Тренировка DEF (+2)',   cost: 100 },
        { id: 'train_spd',  label: '💨 Тренировка SPD (+1)',   cost: 80  },
        { id: 'train_crit', label: '🎯 Тренировка КРИТ (+3%)', cost: 120 },
      ],
    },
    {
      id: 'scout',
      av: '🗺️',
      name: 'Разведчик Лекс',
      title: 'Знаток подземелий',
      unlockLv: 1,
      greetings: {
        newbie: ['Эй, зелёный! Хочешь знать где опасно?', 'Информация — лучшее оружие новичка.'],
        weak:   ['Ты уже кое-что повидал. Расскажу больше.', 'Карты — моя специальность.'],
        mid:    ['Ты знаешь многое. Но я знаю больше!', 'Хочешь узнать секреты зон?'],
        strong: ['Даже опытные герои ценят мои разведданные.', 'Что ищешь на этот раз?'],
      },
      services: [
        { id: 'advice_zone',  label: '🗺️ Совет по зоне',         cost: 0  },
        { id: 'reveal_zone',  label: '👁️ Бестиарий зоны',         cost: 20 },
        { id: 'buff_xp',      label: '📚 Эликсир знаний (+50%XP)', cost: 60 },
        { id: 'buff_drop',    label: '🍀 Удача добычи (+дроп)',    cost: 60 },
      ],
    },
    {
      id: 'guild_master',
      ...
      unlockLv: 5,
      greetings: {
        newbie: ['Новый член гильдии? Докажи свою ценность.', 'Гильдия ждёт твоих подвигов.'],
        weak:   ['Ты делаешь успехи. Продолжай.', 'Ранг растёт — уважение растёт.'],
        mid:    ['Достойный гильдиец. Горжусь тобой.', 'Твои победы прославляют нашу гильдию.'],
        strong: ['Легенда гильдии стоит передо мной!', 'Наша гильдия процветает благодаря тебе.'],
      },
      services: [
        { id: 'rank_info',  label: '🏆 Информация о ранге',    cost: 0   },
        { id: 'buff_gxp',   label: '⭐ Благословение (+50%GXP)', cost: 80  },
      ],
    },
    {
      id: 'fence',
      av: '🕵️',
      name: 'Барыга Скрыт',
      title: 'Скупщик редкостей',
      unlockLv: 7,
      greetings: {
        newbie: ['Псст! Есть что продать?', 'Я плачу лучше всех — за нужный товар.'],
        weak:   ['Снова ты. Принёс что-нибудь интересное?', 'Редкие части монстров — моя страсть.'],
        mid:    ['О, серьёзный охотник! Покажи добычу.', 'Твои трофеи стоят хороших денег у меня.'],
        strong: ['Легендарный охотник! Жду твоих редкостей.', 'Только лучшим — лучшие цены.'],
      },
      services: [
        { id: 'fence_eval',       label: '🔍 Оценить редкие части', cost: 0  },
        { id: 'fence_buy_parts',  label: '💰 Продать редкие части (×2)', cost: 0 },
      ],
    },
  ],
});

// ── ГЛОБАЛЬНЫЙ ЭКСПОРТ (для доступа между скриптами) ────────────
window.ZoneConfig            = ZoneConfig;
window.MonsterRarityConfig   = MonsterRarityConfig;
window.ItemConfig            = ItemConfig;
window.ClassConfig           = ClassConfig;
window.PetConfig             = PetConfig;
window.QuestConfig           = QuestConfig;
window.SubclassConfig        = SubclassConfig;
window.SpecializationConfig  = SpecializationConfig;
window.GatheringRarityConfig = GatheringRarityConfig;
