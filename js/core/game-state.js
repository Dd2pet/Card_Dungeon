class GameState {
  constructor() {
    ...
    // Состояние ограничений классов (усталость воина, обет паладина,
    // дистанция стрелка, заметность ассасина, перегрузка мага).
    // Используется WarriorFatigueModule / PaladinOathModule / RangerDistanceModule /
    // RogueVisibilityModule / MageOverloadModule через State.getConstraints().
    this._constraints = {
      warrior: { fatigue: 0, fatigueMax: 100, fatiguePerAttack: 6, fatiguePerSkill: 12, fatigueDecayPerTurn: 8 },
      paladin: { oath: 100, oathMax: 100, oathCostSkill: 5, oathCostFlee: 20, oathRegen: 4 },
      ranger:  { distance: 100, distMax: 100, distDecayOnHit: 15, distRegenPerTurn: 6 },
      rogue:   { visibility: 0, visMax: 100, visThreshold: 60, visPerAttack: 10, visDecayPerTurn: 6 },
      mage:    { overload: 0, overMax: 100, overThreshold: 60, overPerSkill: 18, overDecayPerTurn: 10 },
    };
  }
  ...
  // Возвращает объект состояния ограничений всех классов
  // (см. js/classes/class-modules.js, js/classes/class-constraints.js)
